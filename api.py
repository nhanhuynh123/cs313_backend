...
async def get_students():
    user_df = pl.read_parquet("/Users/cicilian/Desktop/CS313/merged_data/user_df.parquet")
    students = (
...
async def get_courses():
    course_df = pl.read_parquet("/Users/cicilian/Desktop/CS313/merged_data/course_df.parquet")
    courses = (
...
async def get_courses():
    fields_df = pl.read_parquet("/Users/cicilian/Desktop/CS313/merged_data/field_df.parquet")
    fields = (
...
async def get_courses():
    teacher_df = pl.read_parquet("/Users/cicilian/Desktop/CS313/merged_data/teacher_df.parquet")
    teacher = (
